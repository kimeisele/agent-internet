...
def build_lotus_capability_manifest(*, base_url: str | None = None) -> dict:
    ...
    return {
        ...
        "parseability": {
            ...
            "resource_change_feed_response_fields": ["items", "filters", "page", "checkpoint", "watch"],
            ...
            "resource_change_feed_watch_fields": ["mode", "reason", "continue_immediately", "recommended_wait_ms", "next_request"],
            "resource_change_feed_watch_next_request_fields": ["lotus_action", "http_path", "params"],
